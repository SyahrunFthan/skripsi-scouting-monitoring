...
import { FaChalkboard, FaChartBar, FaFileAlt, FaTrophy } from "react-icons/fa";

const CardWidgetComponents = () => {
  return (
    <div className="flex flex-col items-start lg:flex-row md:flex-row md:items-center lg:items-center w-full gap-4 justify-start">
      <div className="flex items-center lg:items-start md:items-start lg:flex-col md:flex-col gap-3 md:gap-0 lg:gap-0 rounded-md bg-white shadow-md lg:p-3 md:p-3 w-full lg:w-[25%] md:w-[25%]">
        <div
      ...
      <div className="flex items-center lg:items-start md:items-start lg:flex-col md:flex-col gap-3 md:gap-0 lg:gap-0 rounded-md bg-white shadow-md lg:p-3 md:p-3 w-full lg:w-[25%] md:w-[25%]">
        <div
          className={`flex flex-col lg:w-16 md:w-16 lg:h-16 md:h-16 w-20 h-20 justify-center items-center rounded-l-md lg:rounded-md md:rounded-md bg-yellow-300 text-white`}
        >
          <FaFileAlt />
        </div>
        <div className="flex flex-col mt-2">
